...
$brave.Add_Click({
    ...
    New-Item -Path "\AHK" -Name "AHK" -ItemType "directory"
    Start-BitsTransfer -Source "https://x.jafc.pro/W10S1" -Destination \AHK\Bindings.exe | Out-Host
